...
in the v1 we are unable to export the activities to pdf however we achieved the same to doc file.
We planning to come up with the pdf in the v2

Now we are done with the v1.
